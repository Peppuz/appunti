...
\input{Capitolo/Algoritmi/insertionSort}%Algoritmo di Insertion Sort
...
\input{Capitolo/Algoritmi/selectionSort}%Algoritmo di Selection Sort
...
\input{Capitolo/Algoritmi/linearSearch}%Algoritmo linearSearch


\input{Capitolo/Algoritmi/binarySearch}%Algoritmo binarySearch
