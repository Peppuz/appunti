...
\input{Capitolo/divideetimpera}%Capitolo 2 Divide et Impera
\input{Capitolo/crescitaFunz}%Capitolo 3 Crescita delle funzioni
\input{Capitolo/Algoritmi/quicksort}%Capitolo 4 QuickSort
%\input{Esercitazioni/esercizi}%Esercizi Algoritmi
\input{StruttureDati/struttureDatiElementari}%Capitolo 5 Strutture Dati elementari
\input{StruttureDati/Heap/heap} Capitolo 6 Heap
%Capitolo 7 Alberi
