...
\begin{codebox}
\Procname{\textbf{List*} $\proc{List-Max}(\textbf{List}L)$}
...
\begin{codebox}
\Procname{$\textbf{List*} \proc{List-Min}(\textbf{List}L)$}
\li \If $\attrib{L}{head} \isequal \const{nil}$
    \Then
\li                \Return $\const{nil}$
...
\begin{codebox}
\Procname{$\textbf{List*} \proc{List-Successor}(\textbf{List}L,\textbf{int} key)$}
\li \If $\attrib{L}{head} \isequal \const{nil}$
    \Then
\li                \Return $\const{nil}$
...
\begin{codebox}
\Procname{$\textbf{List*} \proc{List-Predeccessor}(\textbf{List}L,\textbf{int} key)$}
\li \If $\attrib{L}{head} \isequal \const{nil}$
    \Then
\li                \Return $\const{nil}$
