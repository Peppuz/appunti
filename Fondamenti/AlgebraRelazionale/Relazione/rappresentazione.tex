...
%\input{Grafo/esempio3}%Esempio Matrice Booleana
...
%\input{Grafo/esempio4}Esempio sulle operazioni join,meet e prodotto booleano
Inserire Esempi

%Grafi
\input{AlgebraRelazionale/Grafi/grafi}
