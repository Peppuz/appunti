...
\input{AlgebraRelazionale/ordinali}%Capitolo sui numeri ordinali
\input{AlgebraRelazionale/booleana}%Capitolo sulla Algebra Booleana
\input{AlgebraRelazionale/induzione}%Capitolo Induzione
\input{Logica/Proposizionale/proposizionale}%Capitolo Logica Proposizionale
\input{Logica/Predicativa/predicativa}%Capitolo Logica Predicativa
\end{document}
